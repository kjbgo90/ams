...
<head>
    ...
    <link href="/AMS2/demo/css/bootstrap.min.css" rel="stylesheet">
	<link href="/AMS2/demo/css/demo/nifty-demo-icons.min.css" rel="stylesheet">

    <!--Nifty Stylesheet [ REQUIRED ]-->
    <link href="/AMS2/demo/css/nifty.min.css" rel="stylesheet">
...
<body>
					    ...
					    <div class="col-lg-10 col-lg-offset-1">
					        <div class="panel panel-body">
								<div class="panel-body">
									<div class="col-lg-4"
										style="position: absolute; width: 300px; margin: 140px 0px 0px 200px;">
										...
										<div class="panel">
											<div class="blog-header">
												<img class="img-responsive align-center"
													src="/AMS2/demo/img/ams.png" alt="Image">
											</div>
										</div>
									</div>
										...
										<div class="cls-content-sm panel">
											...
											<div class="pad-all">
												<a href="pages-password-reminder.html"
													class="btn-link mar-rgt">Forgot password ?</a> <a
													href="pages-register.html" class="btn-link mar-lft">Create
													a new account</a>
											</div>
										</div>
									</div>
					...
					<div class="col-lg-10 col-lg-offset-1">
					    <div class="panel panel-body">
					    	...
					    	<div class="col-lg-4" style="position: absolute; width: 800px; margin: 0px;">
									...
									<div class="panel">
										<div class="blog-header">
											<img class="img-responsive align-center" src="demo/img/notice.jpg" alt="Image">
										</div>
									</div>
							  </div>
					...
					<div class="row">
						<div class="col-lg-6 col-lg-offset-1">
							<div class="panel panel-body">
								...
								<div class="panel">
									<div class="blog-header">
										<img class="img-responsive" src="demo/img/shared-img-5.jpg" style="width: 300px; " alt="Image">
									</div>
									<div class="blog-content">
										<div class="blog-title media-block">
											<div class="media-right textright">
												<a href="#"
													class="btn btn-icon demo-psi-twitter icon-lg add-tooltip"
													data-original-title="Twitter" data-container="body"></a> <a
													href="#"
													class="btn btn-icon demo-psi-instagram icon-lg add-tooltip"
							...
							<div class="panel panel-body">
								...
								<div class="col-sm-6">
									<div class="mar-all">
										...
										<p>
											<i class="icon-lg icon-fw demo-pli-old-telephone"></i> <span>(123)
												456-7890</span>
										</p>
										<div class="pad-btm">
    ...
    <!--jQuery [ REQUIRED ]-->
    <script src="${pageContext.request.contextPath }/demo/js/jquery.min.js"></script>


    <!--BootstrapJS [ RECOMMENDED ]-->
    <script src="${pageContext.request.contextPath }/demo/js/bootstrap.min.js"></script>

    
    <!--Nifty Admin [ RECOMMENDED ]-->
    <script src="${pageContext.request.contextPath }/demo/js/nifty.min.js"></script>
